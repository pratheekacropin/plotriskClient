...
class WeatherDataResponse(object):
    ...
    def __init__(self, boundary_id=None, created_date_time=None, _date=None, external_id=None, gdd=None, id=None, modified_date_time=None, org_id=None, plot_name=None, properties=None, status=None, tenant_type=None, weather=None, _configuration=None):  # noqa: E501
