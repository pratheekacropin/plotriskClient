...
class Weather(object):
    ...
    def __init__(self, day_rh=None, day_temperature=None, diurnal_temperature=None, gdd=None, mean_temperature=None, night_rh=None, night_temperature=None, precipitation=None, wind_speed=None, _configuration=None):  # noqa: E501
